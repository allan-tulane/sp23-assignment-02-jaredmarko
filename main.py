...
def subquadratic_multiply(x, y):
  ...
  if (xvec in l2 and yvec in l2):
    ...
    ko1 = subquadratic_multiply(bit_shift(two, n),
                                subquadratic_multiply(x_left, x_right))
    ko2 = subquadratic_multiply(
      bit_shift(two, n // 2),
      subquadratic_multiply(x_left + x_right, y_left + y_right) -
      subquadratic_multiply(x_left, y_left) -
      subquadratic_multiply(x_right, y_right))
